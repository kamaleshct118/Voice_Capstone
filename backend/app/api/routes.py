...
async def classify_medicine_endpoint(
    ...
    if mode in ("image", "image+text") and image:
    ...
    # The 'purpose' generated by Gemini already beautifully explains the medicine and what it's for,
    # so we just read the purpose directly without redundantly injecting 'is a medication used for...'
    voice_text = f"{data.get('purpose', 'I could not determine the details of this item.')} Please consult a pharmacist for personal advice."
